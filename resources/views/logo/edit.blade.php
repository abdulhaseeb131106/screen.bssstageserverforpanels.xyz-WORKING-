...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit logos images</h1>
    </div>

    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">logos images Details</h6>
        </div>
        <div class="card-body">
            @if ($errors->any())
            ...
            <form action="{{ route('logo.update', $logo->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <div class="col-md-4">
                        <label for="">Id</label>
                        <input type="number" class="form-control" readonly name="id" value="{{$logo->id }}">
                    </div>
                    <div class="col-md-4">
