                    ...
                    <div class="col-md-4">
                        ...
                        <select name="region_id" id="region" class="form-control">
                            ...
                            @foreach($regions as $region)
                                <option value="{{$region->id}}" {{ $centre->region_id == $region->id ? 'selected' : '' }} >{{$region->region_name}}</option>
                            @endforeach
                        </select>
                    </div>
                 <div class="col-md-4">
                            ...
                            @foreach($counties as $county)
                                <option value="{{$county->id}}"{{ $centre->county_id == $county->id ? 'selected' :'' }}>{{$county->county_name}}</option>
                            @endforeach
                            </select>
                        </div>
